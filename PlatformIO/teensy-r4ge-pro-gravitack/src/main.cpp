...
{
  Serial.begin(9600);
  Serial.println("Teensy R4ge Pro - Gravitack"); 
  delay(100);
...
void drawTitleScreen()
{
  ...
  tft.writeRect(20, 60, 279, 77, (uint16_t *)gravitack_title);
