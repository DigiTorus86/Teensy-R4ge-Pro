...
#else
#define PIN_JOY2_A1X    16
#define PIN_JOY2_A2Y    17
#define PIN_JOY2_BTN    24 // Encoder button
#define PIN_KEY_USER1   2  // BTN A
#define PIN_KEY_USER2   3  // BTA B
#define PIN_KEY_USER3   4  // BTN X
#define PIN_KEY_USER4   5  // BTN Y

// Second joystick
#define PIN_JOY1_BTN     24  // Encoder button
#define PIN_JOY1_1       32  // UP
#define PIN_JOY1_2       31  // DOWN
#define PIN_JOY1_3       29  // RIGHT
#define PIN_JOY1_4       30  // LEFT
#endif
